...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit_game_full'])) {
    ...
    if (!empty($title) && !empty($cover_url) && $edit_game_id > 0) {
        try {
            ...
            if ($stmt->execute([$title, $description, $cover_url, $tags, $features_str, $languages_str, $platforms_str, $developer, $publisher, $release_date, $sys_min, $sys_rec, $screenshot1, $screenshot2, $screenshot3, $screenshot4, $edit_game_id])) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_game'])) {
    ...
    if (!empty($title) && !empty($cover_url)) {
        try {
            ...
            if ($stmt->execute([$title, $description, $cover_url, $tags, $features_str, $languages_str, $platforms_str, $developer, $publisher, $publisher_id, $release_date, $sys_min, $sys_rec, $screenshot1, $screenshot2, $screenshot3, $screenshot4, $screenshot5])) {
        ...
        <div class="col-md-9">
            <div class="tab-content bg-dark border border-secondary rounded p-4 shadow-sm" id="v-pills-tabContent" style="min-height: 600px;">
                ...
                <div class="tab-pane fade" id="v-pills-steam">
                    ...
                    <div class="bg-dark p-4 rounded border border-secondary shadow-sm">
                        <p class="text-white-50 small mb-4">Введіть назву гри англійською мовою. Система знайде її в магазині Steam та дозволить імпортувати в БД в один клік.</p>
