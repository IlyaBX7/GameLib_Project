...
<div class="container content-section">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 p-3" style="background-color: #1b2838; border-radius: 4px;">
        ...
        <img src="<?php echo htmlspecialchars(resolve_url($game['cover_url'])); ?>" style="height: 60px; border-radius: 2px;">
    </div>
    ...
    <div class="achievements-list">
        ...
        <div class="achievement-row d-flex align-items-center mb-1 p-2">
            <img src="<?php echo htmlspecialchars(resolve_url($ach['icon_url'])); ?>" class="achievement-icon" alt="icon">
